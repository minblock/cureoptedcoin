...
"""Verify that starting cureoptedcoins with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cureoptedcoins with -h for help text")
        ...
        self.log.info("Start cureoptedcoins with -version for version information")
        ...
        self.log.info("Start cureoptedcoinsd with -fakearg to make sure it does not start")
