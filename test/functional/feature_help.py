...
"""Verify that starting cureoptedcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start cureoptedcoin with -h for help text")
        ...
        self.log.info("Start cureoptedcoin with -version for version information")
        ...
        self.log.info("Start cureoptedcoind with -fakearg to make sure it does not start")
