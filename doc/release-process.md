...
* Update manpages, see [gen-manpages.sh](https://github.com/minblock/cureoptedcoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/minblock/cureoptedcoin-detached-sigs.git
...
- Detached signatures will then be committed to the [cureoptedcoin-detached-sigs](https://github.com/minblock/cureoptedcoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/minblock/cureoptedcoin/releases/new) with a link to the archived release notes.
