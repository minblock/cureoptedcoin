...
The default minimum transaction fee `-mintxfee` has been lowered to 0.0001 GRZ/kB after relaxing the minimum relay and dust relay fee rates in prior releases. 
...
- New `fees` field introduced in `getrawmempool`, `getmempoolancestors`, `getmempooldescendants` and
   ...
   and `descendant` denominated in GRZ. This new field deprecates previous fee fields, such as
