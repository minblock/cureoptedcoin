# Support for Output Descriptors in Cureoptedcoins Core

Since Cureoptedcoins Core v0.17, there is support for Output Descriptors. This is a
...
on Cureoptedcoins's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Cureoptedcoins Core wallets, a convenience function `combo` is
