# Support for Output Descriptors in Cureoptedcoin Core

Since Cureoptedcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Cureoptedcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Cureoptedcoin Core wallets, a convenience function `combo` is
