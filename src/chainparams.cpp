...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("8301b789cd06cbb434524741275074f1c4bd2f0efb00dd93a0f12373106e9924");
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nStartTime = 11587458078; // April 21th 2020
        consensus.vDeployments[Consensus::DEPLOYMENT_CSV].nTimeout = 1628410088; // 21-08-08 08:08:08 UTC

        // Deployment of SegWit (BIP141, BIP143, and BIP147)
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].bit = 1;
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nStartTime = 11587458078; // April 21th 2020
        consensus.vDeployments[Consensus::DEPLOYMENT_SEGWIT].nTimeout =  1628410088; // 21-08-08 08:08:08 UTC

        // The best chain should have at least this much work.
        consensus.nMinimumChainWork = uint256S("0x00");

        // By default assume that the signatures in ancestors of this block are valid.
        consensus.defaultAssumeValid = uint256S("0x8301b789cd06cbb434524741275074f1c4bd2f0efb00dd93a0f12373106e9924"); //0
        ...
        genesis = CreateGenesisBlock(1587458078, 1120065, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x8301b789cd06cbb434524741275074f1c4bd2f0efb00dd93a0f12373106e9924"));
        ...
        vSeeds.emplace_back("dnsseed.cureoptedcointools.com");
        vSeeds.emplace_back("dnsseed.cureoptedcoinpool.org");
